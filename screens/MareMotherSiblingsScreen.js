...
function MareMotherSiblingsScreen({ route, navigation }) {
    ...
    return (
        <View>
            ...
            <View style={styles.container}>
                ...
                <MyHeader Title="Mare (Mother) Siblings"
                            ...
                            <View style={{ paddingLeft: 20, padding: 10, paddingBottom: '2%' }}>
                                ...
                                <Animated.FlatList
                                    ...
                                    renderItem={({ item, index }) => {
                                        ...
                                        onPress={() => {
                                            navigation.navigate('HorseDetailScreenSiblingMare', {
...
export default MareMotherSiblingsScreen;
