...
export function HypoMating({ navigation, route, props }) {
        ...
        <View style={styles.container}>
            ...
            >
                <View style={styles.InputContainer}>
                    ...
                    <TouchableOpacity
                        onPress={() => {
                            navigation.navigate('HypotheticalSearchModalSire2', {
                                isSire: true,
                                HorseId: getSireId,
                            })
                        }}
                ...
                <View style={{ bottom: 5 }}>
                    ...
                    <View style={styles.InputContainer2}>
                        ...
                        <TouchableOpacity
                            onPress={() => {
                                navigation.navigate('HypotheticalSearchModalMare2', {
                                    isSire: false,
                                    MareId: getMareId
                                })
                            }} style={styles.TwoValueInLineButton}
