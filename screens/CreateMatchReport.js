...
export function CreateMatchReport({ navigation, route }) {
    ...
    return (
        <View style={styles.container}>
            <MyHeader Title={t('CreateMatchReport')}
            ...
            >
                ...
                <View style={[styles.action, { top: 5 }]}>
                    ...
                    <RNPickerSelect
                        ...
                        Icon={() => {
                            return <Feather style={{ paddingRight: Platform.OS == 'ios' ? '14%' : '17%', top: '1%', }} name="chevron-down" color="grey" size={20} />
                        }}
                ...
                <View style={{ bottom: 5 }}>
                    ...
                    <View style={styles.InputContainer}>
                        ...
                        <TouchableOpacity
                            onPress={() => {
                                navigation.navigate('EffectiveNickSearchModal2', {
                                    HorseId: getHorseId
                                })
                            }}
