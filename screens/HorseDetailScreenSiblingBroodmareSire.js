    ...
    const readSiblingBroodmareSire = async () => {
        try {
            if (Global.Token !== null) {
                fetch('https://api.pedigreeall.com/HorseInfo/GetSiblingsFromBroodmareSireByHorseId?p_iHorseId=' + HORSE_ID, {
                    method: 'GET',
                    headers: {
...
export default HorseDetailScreenSiblingBroodmareSire;
