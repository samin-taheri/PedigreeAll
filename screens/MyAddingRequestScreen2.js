...
import { View, StyleSheet, TouchableOpacity, TextInput, Text, Button, Platform, Image } from 'react-native';
...
export function MyAddingRequestScreen2({ navigation }) {
    ...
    return (
        ...
        <ScrollView style={styles.ScrollViewContainer}>
            {showReport ?
                ...
                <>
                    <View style={{ marginVertical: 20, bottom: 10, left: 15 }}>
                        <TouchableOpacity
                            onPress={() => {
                                setShowReport(true);
                                readGetHorseAddRequest()
                            ...
                            style={{ width: '100%', flexDirection: 'row', padding: 10, borderBottomWidth: 0.5, borderColor: 'silver', marginBottom: 0 }}>
