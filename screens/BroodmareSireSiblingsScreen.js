...
import { View, Animated, StyleSheet, Text, Dimensions, TouchableOpacity, Image, StatusBar, Keyboard } from 'react-native'
...
function BroodmareSireSiblings({ route, navigation }) {
    ...
    return (
        <View>
            ...
            <View style={styles.container}>
                ...
                <MyHeader Title="Broodmare Sire Siblings"
                            ...
                            <View style={{ paddingLeft: 20, padding: 10, paddingBottom: '2%' }}>
                                ...
                                <Animated.FlatList
                                    ...
                                    renderItem={({ item, index }) => {
                                        ...
                                        onPress={() => {
                                            navigation.navigate('HorseDetailScreenSiblingBroodmareSire', {
...
export default BroodmareSireSiblings;
